<div class="list-group">
  ...
  <?php } ?>
  <a href="{$address}" class="list-group-item">{$text_address}</a> <a href="{$wishlist}" class="list-group-item">{$text_wishlist}</a> <a href="{$order}" class="list-group-item">{$text_order}</a> <a href="{$download}" class="list-group-item">{$text_download}</a> <a href="{$reward}" class="list-group-item">{$text_reward}</a> <a href="{$return}" class="list-group-item">{$text_return}</a> <a href="{$transaction}" class="list-group-item">{$text_transaction}</a> <a href="{$newsletter}" class="list-group-item">{$text_newsletter}</a><a href="{$recurring}" class="list-group-item">{$text_recurring}</a>
  {if $logged}
