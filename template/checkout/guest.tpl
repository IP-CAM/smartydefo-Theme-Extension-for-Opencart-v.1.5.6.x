  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div id="payment-custom-field{$custom_field.custom_field_id}" class="form-group custom-field" data-sort="{$custom_field.sort_order}">
        ...
        <input type="hidden" name="custom_field[{$custom_field.location}][{$custom_field.custom_field_id}]" value="{(isset($guest_custom_field[$custom_field.custom_field_id]) ? $guest_custom_field[$custom_field.custom_field_id] : '')}" id="input-payment-custom-field{$custom_field.custom_field_id}" />
      </div>
      <?php } ?>
