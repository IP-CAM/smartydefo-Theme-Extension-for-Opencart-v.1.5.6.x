{if $checkout_method == 'iframe'}
  <iframe name="hss_iframe" width="560px" height="540px" style="border:0px solid #DDDDDD; margin-left:210px;" scrolling="no" src="{HTTPS_SERVER.'index.php?route=payment/pp_pro_iframe/create'}"></iframe>
{else}
  {if !$error_connection}
