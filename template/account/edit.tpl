      ...
      <form action="{$action}" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group{($custom_field.required ? ' required' : '')} custom-field" data-sort="{$custom_field.sort_order}">
            <label class="col-sm-2 control-label" for="input-custom-field{$custom_field.custom_field_id}">{$custom_field.name}</label>
            <div class="col-sm-10">
              <textarea name="custom_field[{$custom_field.custom_field_id}]" rows="5" placeholder="{$custom_field.name}" id="input-custom-field{$custom_field.custom_field_id}" class="form-control">{(isset($account_custom_field[$custom_field.custom_field_id]) ? $account_custom_field[$custom_field.custom_field_id] : $custom_field.value)}</textarea>
              {if isset($error_custom_field[$custom_field.custom_field_id])}
              <div class="text-danger">{$error_custom_field[$custom_field.custom_field_id]}</div>
              <?php } ?>
            </div>
          ...
          <div class="form-group{($custom_field.required ? ' required' : '')} custom-field" data-sort="{$custom_field.sort_order}">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="custom_field[{$custom_field.custom_field_id}]" value="{(isset($account_custom_field[$custom_field.custom_field_id]) ? $account_custom_field[$custom_field.custom_field_id] : '')}" />
              {if isset($error_custom_field[$custom_field.custom_field_id])}
              <div class="text-danger">{$error_custom_field[$custom_field.custom_field_id]}</div>
              <?php } ?>
            </div>
